...
QuestionModel.save = async (data, condition = []) => {
...
QuestionModel.delete = async (condition) => {
...
QuestionModel.getBy = async (condition = [], join = [], group = [], limit = null) => {
...
QuestionModel.getAll = async ({condition = [], join = [], group = [], sort = [], page = null, limit = null, fields = ['*']}) => {
    const now = new Date();
    CoreDB.select(tableName);
...
QuestionModel.getCount = async ({condition = [], join = [], group = [], sort = []}) => {
    CoreDB.select(tableName);

...
CategoryModel.save = async (data, condition = []) => {
...
CategoryModel.delete = async (condition) => {
...
CategoryModel.getBy = async (condition = [], join = [], group = [], limit = null) => {
...
CategoryModel.getAll = async ({condition = [], join = [], group = [], sort = [], page = null, limit = null, fields = ['*']}) => {
    const now = new Date();
    CoreDB.select(tableName);
...
CategoryModel.getCount = async ({condition = [], join = [], group = [], sort = []}) => {
    CoreDB.select(tableName);
